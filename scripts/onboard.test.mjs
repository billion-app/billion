...
test("marks an onboarding-created env file as generated and secret", () => {
  const result = generatedEnvFromTemplate(
    "# generated template\n# instructions\n\nPOSTGRES_URL=example\n",
  );
  assert.match(result, /^# THIS FILE WAS GENERATED BY `pnpm onboard`\./);
  assert.match(result, /Do not commit it/);
  assert.match(result, /POSTGRES_URL=example/);
