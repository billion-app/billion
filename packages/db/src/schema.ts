...
// Bills table for congressional legislation - updated to remove fullText
export const Bill = pgTable(
  ...
  (t) => ({
    ...
    // summary/description (B). Backs the `content.search`
    // procedure alongside the trigram index below for loose code matching.
    // Removed full text indexing to avoid the 1MB limit issue
