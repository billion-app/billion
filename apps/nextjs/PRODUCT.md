...
1. **One signature interactive moment, not decoration everywhere.** The raw-source → Billion-brief transformation _is_ the product. It should be the thing people remember and should be genuinely interactive, not just scroll-scrubbed.
