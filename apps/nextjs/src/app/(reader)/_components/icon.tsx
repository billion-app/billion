/**
 * The phone's icon set (Feather, via `apps/expo/src/components/ui/Icon.tsx`)
 * as inline SVG, so the two surfaces draw the same glyphs. Stroke icons use
 * `currentColor`; size them with `size` and colour them with text colour.
 */
