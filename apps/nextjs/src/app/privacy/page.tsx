...
const SECTIONS = [
  ...
  },
  {
    ...
    body: "Because Billion does not require an app account, we do not require an account-based profile to use the app. Waitlist email addresses are retained until you unsubscribe or ask us to delete them. Feedback is retained in Google Forms or email so that we can act on it. Push tokens and delivery records are retained while an installation is eligible for alerts; invalid tokens are disabled when the delivery provider reports them. Your selected registered address remains on your device until you change it, clear it, or uninstall the app; server lookup caches use a hashed address key, may contain normalized address components, and expire automatically within about thirty days. Analytics and handled-error diagnostic data are retained by our analytics provider according to its retention settings.",
  },
  {
    title: "8. Your Choices",
    body: "You can control your information in several ways. You can turn breaking-news alerts off in the app or revoke notification permission in system Settings. You can edit or clear your saved address in the app at any time, and uninstalling the app removes it from your device. Uninstalling the app also stops any further analytics collection from it. You can unsubscribe from waitlist emails at any time. You may also email billionnewsapp@gmail.com to request access to, or deletion of, the information we hold about you — such as your waitlist email address, notification installation, or feedback you have sent — and we will honor applicable requests.",
  },
  {
    title: "9. Security",
