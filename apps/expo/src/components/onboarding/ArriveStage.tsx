...
const INSTANT = [
  { time: "now", title: "Senate", body: "S. 2 passed, 67–32." },
  { time: "now", title: "Ninth Circuit", body: "The order is stayed overnight." },
] as const;

const EVENING = {
  time: "7:00 PM",
  title: "Tonight’s brief",
  body: "Congress, the courts, your state.",
};
...
export function ArriveStage({
  ...
  return (
    <View style={s.root}>
      ...
      <Text style={s.dek}>Pick how the brief finds you.</Text>
      ...
      <Choice
        title="When it moves"
        hint="The moment a vote or order lands"
        selected={instant}
        onPress={onInstant}
      />
      <Choice
        title="Once, at 7"
        hint="One brief, every evening"
        selected={evening}
        onPress={onEvening}
      />
    </View>
