...
const CA_PYRAMID =
  "M32 11L37 31L41 31L42.5 52L23.5 52L25 31L29 31Z";
...
function Infrastructure({ selected }: { selected: boolean }) {
  ...
  return (
    <>
      <Path d="M12 50H52" stroke={SPARK} strokeWidth={1.7} strokeLinecap="round" />
      <Path
...
const PENTAGON =
  "M32 14 L51 27.8 L43.8 50.2 L20.2 50.2 L13 27.8 Z";
...
export function TopicOrb({
  ...
  return (
    <Animated.View layout={LAYOUT} style={{ alignItems: "center", width: size }}>
      <Pressable
        onPress={onPress}
