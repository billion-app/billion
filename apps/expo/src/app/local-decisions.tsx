...
import { DigestPalette, DigestSpace, fontBody, fontDisplay } from "~/styles";
...
function ListState({
  ...
  return (
    <View style={s.center}>
      <Text style={[s.emptyTitle, { color: DigestPalette.inkOnNight }]}>
        {title}
      </Text>
      ...
      {actionLabel && onAction ? (
        ...
        >
          <Text
            style={[s.emptyActionText, { color: DigestPalette.inkOnNight }]}
          >
            {actionLabel}
          </Text>
        </TouchableOpacity>
