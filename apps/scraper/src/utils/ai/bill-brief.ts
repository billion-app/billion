...
- "visual" is optional curated artwork. Use "infrastructure-repair" only for physical road or bridge work, "public-transit" only for rail or bus expansion, "data-privacy" only for personal-data collection or algorithm transparency, and otherwise omit it.
