...
| ------------------------------- | ------------------------------- | --------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `AUTH_DISCORD_ID`               | Startup required                | Discord sign-in                                     | Configure it with `AUTH_DISCORD_SECRET`; Next.js environment validation fails when either credential is absent. Create an app in the [Discord Developer Portal](https://discord.com/developers/applications). |
| `AUTH_DISCORD_SECRET`           | Startup required                | Discord sign-in                                     | Configure it with `AUTH_DISCORD_ID`; this is a server secret and must never be exposed to Expo or browser code.                                                                                               |
...
| Variable                       | Requirement                      | Used for                                                                   | Missing behavior                                                                                                                                                                                                           | Where to get it                                                                                                                                         |
| ------------------------------ | -------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `OPENROUTER_API_KEY`           | Preferred for content enrichment | Articles, summaries, image keywords, feed copy, and dual-lens web research | Environment validation also accepts a local endpoint or the deprecated direct DeepSeek key for `federalregister`, `congress`, and `scotus`.                                                                                | [OpenRouter keys](https://openrouter.ai/settings/keys).                                                                                                 |
