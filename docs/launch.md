...
Address entry on the ballot screens uses the device's native location services
(expo-location) plus typed entry — no Places key and no per-keystroke autocomplete
billing.
