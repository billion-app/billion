...
| Variable                       | Requirement                      | Used for                                                                   | Missing behavior                                                                                                                                                                                                           | Where to get it                                                                                                                                         |
| ------------------------------ | -------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `OPENROUTER_API_KEY`           | Preferred for content enrichment | Articles, summaries, image keywords, feed copy, and dual-lens web research | Environment validation accepts the deprecated direct DeepSeek key instead during migration; one of the two keys is required for `federalregister`, `congress`, and `scotus`.                                               | [OpenRouter keys](https://openrouter.ai/settings/keys).                                                                                                 |
...
| `DEEPSEEK_API_KEY`             | Deprecated fallback              | Direct DeepSeek text and web-search access during migration                | Used only when `OPENROUTER_API_KEY` is absent.                                                                                                                                                                             | [DeepSeek API platform](https://platform.deepseek.com/api_keys).                                                                                        |
